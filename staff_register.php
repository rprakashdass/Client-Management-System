...
if(isset($_POST['register'])){
     ...
     if($staff_info->rowCount() > 0){
      ...
      prompt($prompt);  
        ...
        $insert_user->execute([$name,$dept, $email, $cpass]);
...
<?php echo prompt($prompt);?>
  <div class="container py-5 h-100">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
              <h3>Department</h3>
                <input type="text" name="department" class="form-control form-control-lg" placeholder="enter your department" />
              </div>
            ...
            <div>
              <p class="mb-0"><h4>Have an account already?</h4> <a href="staff_login.php" class="text-white-50 fw-bold"><h4>Sign In</h4></a>
              </p>
            </div>
